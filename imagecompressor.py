#### This is to be ran in windows, just install python 3.11 and the required dependencies, I've added some "sub process" to try to add them, but it could be a bit short. JUST FYI.
